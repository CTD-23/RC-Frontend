...
function Instruct() {
  ...
  const instructions = [ 
    "The following coding competition can be played in three langauges.",
    "These round consists of 6 questions of increasing marks in order. For first right submission, the first participant to submit will receive full marks. For next right submissions, following participants will receive total-1, total-2 and so on marks.",
          ...
          <div>
            <form action="" method="post">
              ...
              <div className="buttonboxouter" >
                ...
                >
                  {termsChecked && <Link to="/question/" style={btnstyle}>Proceed</Link>}
                </button>
              </div>
            </form>
          </div>
